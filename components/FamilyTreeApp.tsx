...
// Utility functions
// ✅ DATABASE-FIRST FIX: Generate proper UUIDs instead of custom IDs
// This ensures all family member IDs can be saved to UUID database columns
const generateId = () => {
  // Use crypto.randomUUID() for proper UUID v4 format
  if (typeof crypto !== 'undefined' && crypto.randomUUID) {
    return crypto.randomUUID();
  }
  // Fallback for older browsers (still generates valid UUID format)
